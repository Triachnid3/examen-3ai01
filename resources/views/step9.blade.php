...
<body class="antialiased">
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 dark:text-white">
                    @php
                        $a = 0;
                        $b = 1;
                        $result = 0;
                    ...
                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Suite de Fibonacci :
                    </h2>
                    @while ($result < 63245986)
                        @php
                            $result = $a + $b;
                            $a = $b;
                            $b = $result;
